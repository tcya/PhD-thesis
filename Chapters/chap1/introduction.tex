...
Another category of diabatization methods is based on physical intuition, with ER diabatization being one of them. The ER diabatization is based on the idea that good diabatic states are supposed to be localized, so the approach defines the diabatic states by minimizing the total electron repulsion
\begin{eqnarray}
