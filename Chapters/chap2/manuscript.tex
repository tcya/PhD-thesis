...
coupling mode involves the  $b_{2u}$ in plane C=C stretching motions of the naphthalene donor and the
 in-plane $\nu_{8}$ (in the Mulliken numbering scheme) ring-squeezing motions of the benzaldehyde acceptor\cite{silva1996theoretical}.
It is interesting to note
that $^{3}B_{2u}$ is also the symmetry of the first triplet $\pi-\pi^{*}$ excited state in naphthalene \cite{aagren1994response},
