...
\chapter{Chapter 4}\label{chap:chapt4}
...
\caption{From top to bottom: the 174th, 175th mode of \textsuperscript{3}NAP state, the 174th, 175th mode of CT state. For clarity, bonds are removed.
}\label{NMT1T3}
\end{figure}
