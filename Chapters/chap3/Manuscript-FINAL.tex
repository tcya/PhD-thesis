...
\chapter{Chapter 3}\footnotetext{Part of this chapter has been published in Xunmo Yang and E. R. Bittner, The Journal of Chemical Physics \textbf{142}, 244114 (2015)}
...
\cite{tamura:107402,tamura:021103,singh:194905,Bittner:2014aa}.
...
benzaldehyde acceptor linked by a variety of bridging units as shown in Fig.~\ref{struct}. \cite{xunmo2014}
\begin{figure}
...
In Ref. \cite{xunmo2014} we showed that both
...
In this paper we analyze the symmetry of PLMs in model donor-bridge-acceptor systems as projected onto the local
...
Our method was detailed in Ref.\cite{xunmo2014} but to be self-contained, we briefly present it here.
...
% when parameterized using accurate quantum chemical data.\cite{xunmo2014}
...
Our group has shown that the dynamics of Hamiltonian in the form of Eq.~\ref{eq:locaiHam} can be expressed in a time-convolutionless mater equation \cite{pereverzev:104906}. The derivation is lengthy so we present it briefly.
...
% In our previous work \cite{xunmo2014},  we presented a Lanczos-base ranking algorithm that project
...
\begin{figure*}[ht]
\subfloat[c-1,4ee]{\includegraphics[width=0.85\columnwidth]{Chapters/chap3/Figure1a.pdf}}
\subfloat[d-2,6ae]{\includegraphics[width=0.85\columnwidth]{Chapters/chap3/Figure1b.pdf}}
\caption{
...
\begin{figure*}[ht]
\subfloat[]{\includegraphics[width=0.85\columnwidth]{Chapters/chap3/Figure2a.pdf}}
\subfloat[]{\includegraphics[width=0.85\columnwidth]{Chapters/chap3/Figure2b.pdf}} \\
\subfloat[]{\includegraphics[width=0.85\columnwidth]{Chapters/chap3/Figure2c.pdf}}
\subfloat[]{\includegraphics[width=0.85\columnwidth]{Chapters/chap3/Figure2d.pdf}}
...
In Fig.~\ref{LanczosModes}  we show the PLMs for the
...
\begin{figure*}[th]
\subfloat[]{\includegraphics[width=0.45\columnwidth]{Chapters/chap3/Figure3a.pdf}}
\subfloat[]{\includegraphics[width=0.45\columnwidth]{Chapters/chap3/Figure3b.pdf}}
\subfloat[]{\includegraphics[width=0.45\columnwidth]{Chapters/chap3/Figure3c.pdf}}
\subfloat[]{\includegraphics[width=0.45\columnwidth]{Chapters/chap3/Figure3d.pdf}}
...
%\caption{The correlation function of PLM compared to the exact one calculated with all normal modes for the (a) c14ee (b) d26ae, with naphthalene replaced by phenyl ring.Their PLMs are in (c) for c14ee and (d) for d26ae.\label{benz}}
\end{figure*}
...
\begin{figure*}[th]
\subfloat[]{\includegraphics[width=0.95\columnwidth]{Chapters/chap3/Figure5a.pdf}}
\subfloat[]{\includegraphics[width=0.95\columnwidth]{Chapters/chap3/Figure5b.pdf}}
...
which is shown in Fig. ~\ref{LancProj}, as a comparison to Fig. ~\ref{fragProj}, where the normal modes of the individual
moieties are used.    It is clear that on the basis of entire molecule, more modes are
significantly involved.   This is in contrast to the projection of the PLM onto only the local modes of the isolated moieties,
only a handful modes contribute.  Since the PLM  best captures the initial nuclear dynamics,
...
\begin{figure*}[tbh]
\subfloat[]{\includegraphics[width=0.95\columnwidth]{Chapters/chap3/Figure6a.pdf}}
\subfloat[]{\includegraphics[width=0.95\columnwidth]{Chapters/chap3/Figure6b.pdf}}
...
%\subfloat[]{\includegraphics[width=0.45\columnwidth]{Chapters/chap3/c14eeNaph1stMode.png}}
%\subfloat[]{\includegraphics[width=0.45\columnwidth]{Chapters/chap3/d26aeNaph1stMode.png}}
%\caption{Projection of PLMs onto unsymmetrized naphthalene for (a) c14ee and (b) d26ae. They are almost same to Fig. ~\ref{fragProj}(b) and (d) except for a mode with $b_{2u}$ symmetry in (c). In the second row are the most dominant mode in projections above, namely, the 33rd normal mode of naphthalene in (c) c14ee and (d) d26ae. The mode in (d) belongs to  $A_g$ representation quite well while in (c), hydrogens move  in the  $B_{2u}$ way. \label{projNaph}}
\end{figure*}
...
\begin{figure*}[tbh]
\subfloat[]{\includegraphics[width=\columnwidth]{Chapters/chap3/Figure7a.pdf}}
\subfloat[]{\includegraphics[width=\columnwidth]{Chapters/chap3/Figure7b.pdf}} \\
\subfloat[]{\includegraphics[width=\columnwidth]{Chapters/chap3/Figure7c.pdf}}
\subfloat[]{\includegraphics[width=\columnwidth]{Chapters/chap3/Figure7d.pdf}}
...
However, as seen on our previous work \cite{xunmo2014},
...
%     \hline
%     Rate constants in c14ee/$s^{-1}$   & 3.66E9 & 3.69E9 & 5.28E9 & 4.31E9   \\
%     Rate constants in d26ae/$s^{-1}$   & 4.66E4 &4.80E4 & 1.30E4 & 5.11E4 \\
%     \hline
%   \end{tabular}
% \end{table*}

%However, this is only one side of the story. In Fig. ~\ref{geomDiffProj} we project geometry change onto the normal modes of molecule. It does not look same to the projections of PLM in Fig. ~\ref{LancProj}. The geometry change of both c14ee and d26ae are dominated by single mode with very low frequency, shown in Fig. ~\ref{geomDiffProj}(c) and (d). We term them the dominant mode relaxation mode (RM) for the reason below. RM does not resemble PLM at all.

\begin{figure*}[th]
\subfloat[]{\includegraphics[width=0.95\columnwidth]{Chapters/chap3/Figure9a.pdf}}
\subfloat[]{\includegraphics[width=0.95\columnwidth]{Chapters/chap3/Figure9b.pdf}}
%\subfloat[]{\includegraphics[width=0.45\columnwidth]{Chapters/chap3/c14eeDADiffproj.pdf}}
%\subfloat[]{\includegraphics[width=0.45\columnwidth]{Chapters/chap3/d26aeDADiffproj.pdf}}
%\subfloat[]{\includegraphics[width=0.45\columnwidth]{Chapters/chap3/c14eeNM2.png}}
%\subfloat[]{\includegraphics[width=0.45\columnwidth]{Chapters/chap3/d26aeNM1.png}}
...
\begin{figure*}[th]
\subfloat[]{\includegraphics[width=0.95\columnwidth]{Chapters/chap3/Figure10a.pdf}}
\subfloat[]{\includegraphics[width=0.95\columnwidth]{Chapters/chap3/Figure10b.pdf}}
\subfloat[]{\includegraphics[width=0.95\columnwidth]{Chapters/chap3/Figure10c.pdf}}
\caption{Correlation functions of relaxation mode (RM), PLM, geometry change (GC), and geometry change with the RM component eliminated for (a) c14ee and (b) d26ae.
(c) Relative comparison of the rate constants computed using different sets of reduced modes.  The exact rate is computed using the full set of normal modes:
blue = c14ee, gold =d26ae. }
\label{Corr}
\end{figure*}
...
time-correlation functions (Fig.~\ref{Corr}(a,b))  and the computed rates for both molecules considered  (Fig.~\ref{Corr}(c)).
...
\bibitem [{\citenamefont {Pereverzev}\ and\ \citenamefont
  {Bittner}(2006)}]{pereverzev:104906}%
  \BibitemOpen
